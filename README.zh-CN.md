...
| 2    | Eval harness（38 条 curated items × 5 类,NIM judge + Gemini 兜底）                                                       | ✅ 已交付 | recall@10 0.80 / MRR 0.64 / nDCG@10 0.65 / citation validity 0.84 / faithfulness 0.88 / correctness 0.84,详见 [`eval/reports/wave_2.md`](eval/reports/wave_2.md) |
